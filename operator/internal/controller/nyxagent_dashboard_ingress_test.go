...
func TestEvaluateDashboardIngressAuth(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			agent: &nyxv1alpha1.NyxAgent{
				Spec: nyxv1alpha1.NyxAgentSpec{Dashboard: &nyxv1alpha1.DashboardSpec{Enabled: true}},
			},
			want: DashboardIngressAuthStatusDisabled,
		},
		{
			...
			agent: &nyxv1alpha1.NyxAgent{
				Spec: nyxv1alpha1.NyxAgentSpec{
					Dashboard: &nyxv1alpha1.DashboardSpec{
						Enabled: true,
						Ingress: &nyxv1alpha1.DashboardIngressSpec{Enabled: false},
					},
				},
			},
			want: DashboardIngressAuthStatusDisabled,
		},
		{
			...
			agent: &nyxv1alpha1.NyxAgent{
				Spec: nyxv1alpha1.NyxAgentSpec{
					Dashboard: &nyxv1alpha1.DashboardSpec{
						Enabled: true,
						Ingress: &nyxv1alpha1.DashboardIngressSpec{Enabled: true},
					},
				},
			},
		...
		},
		{
			...
			agent: &nyxv1alpha1.NyxAgent{
				Spec: nyxv1alpha1.NyxAgentSpec{
					Dashboard: &nyxv1alpha1.DashboardSpec{
						Enabled: true,
						Ingress: &nyxv1alpha1.DashboardIngressSpec{
							Enabled: true,
							Auth:    &nyxv1alpha1.DashboardAuthSpec{Mode: "none"},
						},
					},
				},
			},
			...
			agent: &nyxv1alpha1.NyxAgent{
				Spec: nyxv1alpha1.NyxAgentSpec{
					Dashboard: &nyxv1alpha1.DashboardSpec{
						...
						Ingress: &nyxv1alpha1.DashboardIngressSpec{
							Enabled: true,
							Auth:    &nyxv1alpha1.DashboardAuthSpec{Mode: "basic"},
						},
					},
				},
			},
			...
			agent: &nyxv1alpha1.NyxAgent{
				Spec: nyxv1alpha1.NyxAgentSpec{
					Dashboard: &nyxv1alpha1.DashboardSpec{
						...
						Ingress: &nyxv1alpha1.DashboardIngressSpec{
							Enabled: true,
							Auth:    &nyxv1alpha1.DashboardAuthSpec{Mode: "invalid"},
						},
					},
				},
			},
