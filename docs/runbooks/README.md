...
coverage check expects alert sections in that file.

## Runbooks

- [GitHub agent account](github-agent-account.md) — create and bootstrap a GitHub account for a new self-team agent.
