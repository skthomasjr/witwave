...
2. Write a `project` memory at `/workspaces/witwave-test/memory/agents/bob/claude-memory-check.md` with frontmatter and
...
5. Reply with exactly one line:
   `MEMORY_OK <token> /workspaces/witwave-test/memory/agents/bob/claude-memory-check.md /workspaces/witwave-test/memory/agents/bob/MEMORY.md`.
