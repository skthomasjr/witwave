...
Currently only bob and fred are wired into `charts/witwave/values-test.yaml`. jack and luke exist as filesystem
scaffolds and will land in values-test.yaml when they're needed for smoke runs.
