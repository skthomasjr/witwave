...
Each agent's `.nyx/` directory carries the harness runtime config (agent-card, HEARTBEAT, backend.yaml, and minimal
...
Currently only bob and fred are wired into `charts/nyx/values-test.yaml`. jack and luke exist as filesystem scaffolds
