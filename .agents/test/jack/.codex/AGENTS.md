...
Jack is a general-purpose Codex parity test agent. Respond to requests simply and directly. You can search the web,
...
2. Write a `project` memory at `/workspaces/witwave-test/memory/agents/jack/codex-memory-check.md` with frontmatter and
...
5. Reply with exactly one line:
   `MEMORY_OK <token> /workspaces/witwave-test/memory/agents/jack/codex-memory-check.md /workspaces/witwave-test/memory/agents/jack/MEMORY.md`.
