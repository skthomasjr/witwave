...
1. Read `~/workspace/source/autonomous-agent/docs/features-proposed.md` and locate the `### F-XXX` section matching the
   given feature ID. If it is not found, report the error and stop.
2. Read `~/workspace/source/autonomous-agent/docs/features-completed.md`.
...
1. Read `~/workspace/source/autonomous-agent/docs/features-proposed.md` and locate the `### F-XXX` section. If not
...
4. Read `~/workspace/source/autonomous-agent/TODO.md` and check the existing `## Enhancements` section for any items
