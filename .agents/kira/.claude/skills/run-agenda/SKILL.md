...
Run the named agenda item from `~/.claude/agenda/`.
...
2. Look for the file at `~/.claude/agenda/<agenda-name>.md`. If it does not exist, report the error clearly and stop.
