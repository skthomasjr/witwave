...
Manage `~/workspace/source/autonomous-agent/TODO.md`.
...
1. Read `~/workspace/source/autonomous-agent/TODO.md` and check the status block at the top.
...
1. Read `~/workspace/source/autonomous-agent/TODO.md` and check `locked_by`.
...
1. Read `~/workspace/source/autonomous-agent/TODO.md`.
