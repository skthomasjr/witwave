...
The test passes if all three endpoints return HTTP 200 with the expected fields.
The test fails if any endpoint is unreachable, returns a non-200 status, or is missing expected fields.
