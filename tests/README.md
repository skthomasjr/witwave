...
in bob's environment via `charts/witwave/values-test.yaml`, plus webhook env vars (`WEBHOOK_TEST_HOST`,
`WEBHOOK_TEST_URL_FEATURE_SINK`, `WEBHOOK_TEST_URL_WEBHOOK_SINK`, `WEBHOOK_TEST_TOKEN`, `WEBHOOK_TEST_BEARER`).
Smoke tests use:
